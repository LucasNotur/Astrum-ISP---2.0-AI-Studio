...
interface AppState {
  ...
  setResourcePermissions: (perms: any[]) => void;
...
export const canAccess = (
  role: "admin" | "owner" | "support" | "tecnico" | string,
  tab: string,
...
export const useAppStore = create<AppState>((set) => ({
  ...
  integrationKeys: {},
  setIntegrationKeys: (updater) =>
    set((state) => ({
      integrationKeys:
        typeof updater === "function"
          ? updater(state.integrationKeys)
          : updater,
    })),
  ...
  setCompanySettings: (updater) =>
    set((state) => ({
      companySettings:
        typeof updater === "function"
          ? updater(state.companySettings)
          : updater,
    })),
  ...
  resourcePermissions: [],
  setResourcePermissions: (resourcePermissions) => set({ resourcePermissions }),
  ...
  setSelectedCustomerDetails: (selectedCustomerDetails) =>
    set({ selectedCustomerDetails }),
  ...
  setIsCreateInvoiceDialogOpen: (isCreateInvoiceDialogOpen) =>
    set({ isCreateInvoiceDialogOpen }),
  selectedInvoiceDetails: null,
  setSelectedInvoiceDetails: (selectedInvoiceDetails) =>
    set({ selectedInvoiceDetails }),
}));
