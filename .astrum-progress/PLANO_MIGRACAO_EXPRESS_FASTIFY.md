...
**Próximos BUILD (Apêndice C, 🟢):** `domains/verify`. **REMOVER:** `/api/ai/ask`, `/api/knowledge/articles*`. **VERIFICAR (T2/T3):** ver Apêndice C.
