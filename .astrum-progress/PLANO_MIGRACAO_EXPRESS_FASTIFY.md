...
**Próximos BUILD (Apêndice C, 🟢):** `settings/holidays`, `domains/verify`. **REMOVER:** `/api/ai/ask`, `/api/knowledge/articles*`. **VERIFICAR (T2/T3):** ver Apêndice C.
