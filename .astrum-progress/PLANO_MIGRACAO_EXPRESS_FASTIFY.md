...
**Próximos BUILD (Apêndice C, 🟢):** `quality/live-stats`, `settings/holidays`, `domains/verify`. **REMOVER:** `/api/ai/ask`, `/api/knowledge/articles*`. **VERIFICAR (T2/T3):** ver Apêndice C.
